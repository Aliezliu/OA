...
public class OAController {
	...
	String teacherIntro(Model model,String username){
	...
	String findClass(Model model,String username){
	...
	String searchClass(Model model,String username,Integer id,String name){
	...
	String personMain(Model model,String username){
		Teacher teacher = teacherService.selectTeacher(username);
		model.addAttribute("teacher", teacher);
		return "personMain";
	}
	@RequestMapping("/personCheck")
	String personCheck(Model model,String username,Integer result){
		List<AttendType> type = teacherService.selectAttendType();
		List<Attendance> attendance = teacherService.selectAttendance(result,username);
